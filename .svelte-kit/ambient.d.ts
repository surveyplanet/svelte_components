...
declare module '$env/static/private' {
	...
	export const SP_CLIENT_ID: string;
	...
	export const SP_CLIENT_SECRET: string;
	...
	export const FLUX_FORWARD_NAMESPACE: string;
