...
<div id="example">
	<Story id="form-controls-text-input--basic" />
	<br/>
    <Story id="form-controls-text-input--multiline" />
	<br/>
    <Story id="form-controls-text-input--validate" />
	<br/>
    <Story id="form-controls-text-input--masked" />
